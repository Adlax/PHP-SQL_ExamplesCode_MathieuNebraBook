...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
	...
	<p> <a href="Blog_index2.php">Retour a la liste des billets</a> </p>
	<?php
		try
		{
	...
	Voulez vous poster un commentaires ?;
	
	<form action="Blog_commentaires2_post.php" type="post">
		<label >Votre Pseudo svp ? </label> : <input type="text" name="pseudo"/> <br />
		<label >Votre commentaire? </label> : <input type'text" name="commentaire"/> <br />
